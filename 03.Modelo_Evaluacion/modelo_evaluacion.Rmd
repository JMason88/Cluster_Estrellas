...
PAM_HIP_Canberra <- PAM_loop(diss_canberra_hip,
                          data = hip1[,2:8],
                          k = 20)
...
library(cluster)
library(ClusterR)
diss_mahalanobis_hip <- distance_matrix(hip1[,2:8],method = "mahalanobis")


PAM_HIP_Mahalanobis <- PAM_loop(diss_mahalanobis_hip,
                          data = hip1[,2:8],
                          k = 20)
